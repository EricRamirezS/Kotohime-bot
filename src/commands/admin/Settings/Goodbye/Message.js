...
module.exports = {
    build(builder) {
        ...
        builder.setDescription('Message to send for old users');
        builder.addStringOption(o => o.setName('message').setDescription('Message to send for old users'));
        return builder;
    },
    ...
    async execute(interaction, client) {
        ...
        if (await service.setGoodbyeMessage(message, interaction.guildId)) {
