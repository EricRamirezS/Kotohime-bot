...
module.exports = {
    build(builder) {
        ...
        builder.setDescription('channel to send goodbye message');
        builder.addChannelOption(o => o.setName('channel').setDescription('Channel to send goodbye message').setRequired(true)
    ...
    async execute(interaction, client) {
        ...
        if (await service.setGoodbyeChannel(channelId, interaction.guildId)) {
