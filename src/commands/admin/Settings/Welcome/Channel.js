...
module.exports = {
    build(builder) {
        ...
        builder.setDescription('channel to send welcome message');
        builder.addChannelOption(o => o.setName('channel').setDescription('Channel to send welcome message').setRequired(true)
    ...
    async execute(interaction, client) {
        ...
        if (await service.setWelcomeChannel(channelId, interaction.guildId)) {
